...
const nameBand = 'ARENA HASH';

let nameSongs = [
	"Y ES QUE SUCEDE ASÍ", /*1*/
	"ME RESFRIÉ EN BRASIL", /*2*/
	"COMO TE VA MI AMOR", /*3*/
	"LOS GLOBOS DEL CIELO", /*4*/
	"CUÉNTAME", /*5*/
	"CUANDO LA CAMA ME DA VUELTAS", /*6*/
	"EL REY DEL AH AH AH", /*7*/
	"STRESS", /*8*/
	"A ESE INFIERNO NO VOY A VOLVER", /*9*/
	"EL TÚNEL DEL BUS", /*10*/
	"MURCIÉLAGO RODRIGO", /*11*/
	"MATERIALISMO SEXUAL", /*12*/
	"BÉSAME", /*13*/
	"MUEVE LO QUE PUEDAS.", /*14*/
	"SACUDIA", /*15*/
	"DE TI ME VA QUEDANDO NADA", /*16*/
	"FRUSTRADO EMOCIONAL", /*17*/
	"NO PENSÉ QUE ERA AMOR", /*18*/
	"RECUESTAME", /*19*/
	"EL TRIUNFO TAN SOÑADO", /*20*/
]
